...
namespace Player
{
  ...
  public struct IncreaseStatus
  {
    ...
    public string GetDescription()
    {
      ...
      if (regeneration != 0)
        sb.Append(PlayerStatus.GetTextViaValue("체력 재생: ", regeneration / 10, plus: "")).Append("\n");
      if (drainHp != 0)
        sb.Append(PlayerStatus.GetTextViaValue("흡혈: ", drainHp * 100, plus: "")).Append("\n");
      if (meleeDamage != 0)
      ...
      if (criticalPercent != 0)
        sb.Append(PlayerStatus.GetTextViaValue("치명타 확률: ", criticalPercent * 100, plus: "")).Append("\n");
      if (bleedingDamage != 0)
        sb.Append(PlayerStatus.GetTextViaValue("출혈 피해량: ", bleedingDamage, plus: "")).Append("\n");
      if (attackSpeed != 0)
        sb.Append(PlayerStatus.GetTextViaValue("공격 속도: ", attackSpeed * 100, plus: "")).Append("\n");
      if (range != 0)
      ...
      if (armor != 0)
        sb.Append(PlayerStatus.GetTextViaValue("방어력: ", armor * 100, plus: "")).Append("\n");
      if (moveSpeed != 0)
        sb.Append(PlayerStatus.GetTextViaValue("이동 속도: ", moveSpeed * 100, plus: "")).Append("\n");
      if (luck != 0)
        sb.Append(PlayerStatus.GetTextViaValue("행운: ", luck * 100, plus: "")).Append("\n");
      if (explosionRange != 0)
        sb.Append(PlayerStatus.GetTextViaValue("폭발 범위: ", explosionRange, plus: "")).Append("\n");
      if (evasionRate != 0)
        sb.Append(PlayerStatus.GetTextViaValue("회피율: ", evasionRate * 100, plus: "")).Append("\n");
